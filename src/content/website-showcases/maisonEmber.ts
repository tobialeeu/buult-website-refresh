...
<body class="font-sans font-light selection:bg-ember selection:text-white">
    ...
    <nav id="navbar" class="fixed w-full z-50 transition-all duration-500 py-6 px-16 border-b border-white/5">
        <div class="max-w-[1600px] mx-auto flex justify-between items-center">
            <div class="flex gap-10 text-xs tracking-[0.2em] uppercase text-textPrimary/80">
            ...
            <div class="absolute left-1/2 transform -translate-x-1/2 text-center">
                <a href="#" class="font-serif text-3xl tracking-widest text-white">MAISON EMBER</a>
            </div>

            <div class="flex items-center gap-10 text-xs tracking-[0.2em] uppercase text-textPrimary/80">
                <a href="#" class="hover-line hover:text-white transition-colors">Gallery</a>
                <a href="#" class="border border-ember/60 text-ember px-8 py-3 hover:bg-ember hover:text-white transition-all duration-300">
                    Reservations
                </a>
            </div>
        </div>
    ...
    <header class="relative h-screen w-full flex items-center justify-center parallax-bg bg-hero">
        ...
        <div class="relative z-10 text-center flex flex-col items-center mt-20">
            <span class="text-ember font-sans tracking-[0.3em] uppercase text-sm mb-6 reveal">Established 2026</span>
            <h1 class="hero-title font-serif text-8xl md:text-9xl tracking-wider text-white mb-8 reveal delay-100">
                Forged in Fire.
            </h1>
            <p class="font-serif italic text-2xl md:text-3xl text-textSecondary max-w-2xl mx-auto mb-12 reveal delay-200">
    ...
    <section id="concept" class="py-40 px-16 max-w-[1600px] mx-auto">
        <div class="grid grid-cols-12 gap-16 items-center">
            <div class="col-span-5 reveal concept-copy">
                <span class="text-ember text-xs tracking-[0.2em] uppercase block mb-6">Our Philosophy</span>
                <h2 class="font-serif text-5xl md:text-6xl text-white mb-10 leading-tight">The Alchemy <br>of the Hearth.</h2>
                <div class="font-sans space-y-6 leading-relaxed text-sm md:text-base pr-8">
                    <p>
            ...
            <div class="col-span-7 relative h-[800px] w-full reveal delay-200">
                <div class="absolute top-0 right-0 w-[85%] h-[90%] img-zoom-container bg-surfaceLighter">
                ...
                <div class="absolute bottom-0 left-0 w-[50%] h-[55%] border-8 border-base img-zoom-container bg-surface">
    ...
    <section class="py-40 bg-surface border-y border-white/5">
        <div class="max-w-[1400px] mx-auto px-16 text-center mb-24 reveal">
            <h2 class="font-serif text-5xl md:text-6xl text-white mb-6">The Ember Tasting</h2>
            <p class="font-serif italic text-xl text-textSecondary">A twelve-course journey through the elements.</p>
        </div>

        <div class="max-w-[1600px] mx-auto px-16 grid grid-cols-3 gap-8">
            ...
            <div class="group cursor-pointer reveal delay-200 mt-16">
                <div class="w-full aspect-[4/5] overflow-hidden mb-6 bg-base">
        ...
        <div class="text-center mt-24 reveal">
            <a href="#" class="inline-block border border-white/20 px-10 py-4 text-xs tracking-[0.2em] uppercase text-white hover:bg-white hover:text-base transition-colors duration-500">
                View Full Menu
            </a>
        </div>
    </section>

    <section class="py-40 px-16 max-w-[1600px] mx-auto">
        <div class="grid grid-cols-2 gap-24 items-center">
            <div class="relative aspect-[3/4] img-zoom-container reveal">
                ...
                <div class="absolute bottom-8 left-8">
                    <p class="text-white font-serif text-3xl">Elias Thorne</p>
            ...
            <div class="reveal delay-200">
                ...
                <h2 class="font-serif text-4xl md:text-5xl text-white mb-10 leading-snug">
    ...
    <section class="relative py-48 w-full flex items-center justify-center parallax-bg bg-private-dining border-y border-white/10">
        ...
        <div class="private-dining-copy relative z-10 text-center max-w-3xl px-8 reveal">
            ...
            <h2 class="font-serif text-5xl md:text-6xl text-white mb-8">The Obsidian Room</h2>
            ...
            <a href="#" class="inline-block border border-ember/60 text-ember px-10 py-4 text-xs tracking-[0.2em] uppercase hover:bg-ember hover:text-white transition-all duration-500">
                Inquire Now
            </a>
        </div>
    </section>

    <section class="py-32 bg-surfaceLighter">
        <div class="max-w-[1400px] mx-auto px-16">
    ...
    <section class="py-40 bg-base text-center px-8 relative overflow-hidden">
        <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-ember/5 rounded-full blur-[120px] pointer-events-none"></div>

        <div class="relative z-10 reveal">
            <h2 class="font-serif text-6xl md:text-7xl text-white mb-8">Secure Your Experience</h2>
            <p class="font-sans text-textSecondary text-sm tracking-widest uppercase mb-12">Reservations open 60 days in advance.</p>
            <a href="#" class="inline-block bg-white text-base font-semibold px-12 py-5 text-xs tracking-[0.2em] uppercase hover:bg-ember hover:text-white transition-all duration-500">
                Book a Table
            </a>
        </div>
    </section>

    <footer class="bg-[#050505] pt-24 pb-12 px-16 border-t border-white/5">
        <div class="max-w-[1600px] mx-auto grid grid-cols-4 gap-16 mb-24">
            ...
            <div class="col-span-1">
                ...
                <form class="flex border-b border-textSecondary/30 focus-within:border-ember transition-colors">
        ...
        <div class="max-w-[1600px] mx-auto flex justify-between items-center font-sans text-[10px] tracking-widest uppercase text-textMuted border-t border-white/5 pt-8">
